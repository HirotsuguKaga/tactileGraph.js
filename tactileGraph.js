...
var tactileGraph = function() {
  ...
  convertText:function(str){    //拗音などを記号の組み合わせに変換する
    var arr1 = [['きゃ','拗か'],	['きゅ','拗く'],	['きょ','拗こ'],	['しゃ','拗さ'],	['しゅ','拗す'],	['しょ','拗そ'],	['ちゃ','拗た'],	['ちゅ','拗つ'],	['ちょ','拗と'],	['にゃ','拗な'],	['にゅ','拗ぬ'],	['にょ','拗の'],	['ひゃ','拗は'],	['ひゅ','拗ふ'],	['ひょ','拗ほ'],	['みゃ','拗ま'],	['みゅ','拗む'],	['みょ','拗も'],	['りゃ','拗ら'],	['りゅ','拗る'],	['りょ','拗ろ'],	['いぇ','拗え'],	['きぇ','拗け'],	['しぇ','拗せ'],	['ちぇ','拗て'],	['にぇ','拗ね'],	['ひぇ','拗へ'],	['すぃ','拗し'],	['てぃ','拗ち'],	['ぎゃ','小か'],	['ぎゅ','小く'],	['ぎょ','小こ'],	['じゃ','小さ'],	['じゅ','小す'],	['じょ','小そ'],	['ぢゃ','小た'],	['ぢゅ','小つ'],	['ぢょ','小と'],	['びゃ','小は'],	['びゅ','小ふ'],	['びょ','小ほ'],	['うぃ','+い'],	['うぇ','+え'],	['うぉ','+お'],	['くぁ','+か'],	['くぃ','+き'],	['くぇ','+け'],	['くぉ','+こ'],	['つぁ','+た'],	['つぃ','+ち'],	['つぇ','+て'],	['つぉ','+と'],	['ふぁ','+は'],	['ふぃ','+ひ'],	['ふぇ','+へ'],	['ふぉ','+ほ'],	['ぐぁ','。か'],	['ぐぃ','。き'],	['ぐぇ','。け'],	['ぐぉ','。こ'],	['ヴぁ','。は'],	['ヴぃ','。ひ'],	['ヴぇ','。へ'],	['ヴぉ','。ほ'],	['とぅ','+つ'],	['ずぃ','小し'],	['でぃ','小ち'],	['どぅ','。つ'],	['てゅ','斜つ'],	['ふゅ','斜ゆ'],	['ふょ','斜よ'],	['でゅ','拡つ'],	['ヴゅ','拡ゆ'],	['ヴゅ','拡よ'],	['が','濁か'],	['ぎ','濁き'],	['ぐ','濁く'],	['げ','濁け'],	['ご','濁こ'],	['ざ','濁さ'],	['じ','濁し'],	['ず','濁す'],	['ぜ','濁せ'],	['ぞ','濁そ'],	['だ','濁た'],	['ぢ','濁ち'],	['づ','濁つ'],	['で','濁て'],	['ど','濁と'],	['ば','濁は'],	['び','濁ひ'],	['ぶ','濁ふ'],	['べ','濁へ'],	['ぼ','濁ほ'],	['ぱ','半ほ'],	['ぴ','半ひ'],	['ぷ','半ふ'],	['ぺ','半へ'],	['ぽ','半ほ'],	['キャ','拗カ'],	['キュ','拗ク'],	['キョ','拗コ'],	['シャ','拗サ'],	['シュ','拗ス'],	['ショ','拗ソ'],	['チャ','拗タ'],	['チュ','拗ツ'],	['チョ','拗ト'],	['ニャ','拗ナ'],	['ニュ','拗ヌ'],	['ニョ','拗ノ'],	['ヒャ','拗ハ'],	['ヒュ','拗フ'],	['ヒョ','拗ホ'],	['ミャ','拗マ'],	['ミュ','拗ム'],	['ミョ','拗モ'],	['リャ','拗ラ'],	['リュ','拗ル'],	['リョ','拗ロ'],	['イェ','拗エ'],	['キェ','拗ケ'],	['シェ','拗セ'],	['チェ','拗テ'],	['ニェ','拗ネ'],	['ヒェ','拗ヘ'],	['スィ','拗シ'],	['ティ','拗チ'],	['ギャ','小カ'],	['ギュ','小ク'],	['ギョ','小コ'],	['ジャ','小サ'],	['ジュ','小ス'],	['ジョ','小ソ'],	['ヂャ','小タ'],	['ヂュ','小ツ'],	['ヂョ','小ト'],	['ビャ','小ハ'],	['ビュ','小フ'],	['ビョ','小ホ'],	['ウィ','+イ'],	['ウェ','+エ'],	['ウォ','+オ'],	['クァ','+カ'],	['クィ','+キ'],	['クェ','+ケ'],	['クォ','+コ'],	['ツァ','+タ'],	['ツィ','+チ'],	['ツェ','+テ'],	['ツォ','+ト'],	['ファ','+ハ'],	['フィ','+ヒ'],	['フェ','+ヘ'],	['フォ','+ホ'],	['グァ','。カ'],	['グィ','。キ'],	['グェ','。ケ'],	['グォ','。コ'],	['ヴァ','。ハ'],	['ヴィ','。ヒ'],	['ヴェ','。ヘ'],	['ヴォ','。ホ'],	['トゥ','+ツ'],	['ズィ','小シ'],	['ディ','小チ'],	['ドゥ','。ツ'],	['テュ','斜ツ'],	['フュ','斜ユ'],	['フョ','斜ヨ'],	['デュ','拡ツ'],	['ヴュ','拡ユ'],	['ヴュ','拡ヨ'],	['ヴ','濁ウ'],	['ガ','濁カ'],	['ギ','濁キ'],	['グ','濁ク'],	['ゲ','濁ケ'],	['ゴ','濁コ'],	['ザ','濁サ'],	['ジ','濁シ'],	['ズ','濁ス'],	['ゼ','濁セ'],	['ゾ','濁ソ'],	['ダ','濁タ'],	['ヂ','濁チ'],	['ヅ','濁ツ'],	['デ','濁テ'],	['ド','濁ト'],	['バ','濁ハ'],	['ビ','濁ヒ'],	['ブ','濁フ'],	['ベ','濁ヘ'],	['ボ','濁ホ'],	['パ','半ホ'],	['ピ','半ヒ'],	['プ','半フ'],	['ペ','半ヘ'],	['ポ','半ホ']];
...
['｜|拡','456']];
    ...
    function seek(letter){        //数字コードを取得
      var a = [['.','256'],	[' \(','2356'],	[' \)','2356'],	[' \[','2356'],	[' \]','2356'],	[' \\','4'],	[' \*','16'],	[' ?','26'],	[' \{','2356'],	[' \}','2356'],	[' \^',' '],	[' $','56'],	[' -','36'],	[' \|','456'],	[' \/','34']]
