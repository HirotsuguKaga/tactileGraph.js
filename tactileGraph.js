...
var tactileGraphic = function(ID, SIZE, TYPE, AUG, AUG2) {
 ...
 return {
  ...
  drawBrailleMath:function(str, x, y){
    var code =[["Α","Β","Δ","Ε","Φ","Γ","Ι","Κ","Λ","Μ","Ν","Ο","Π","Ρ","Σ","Τ","Υ","Ω","Ξ","Ψ","Ζ","Η","Θ","Χ","α","β","δ","ε","φ","γ","ι","κ","λ","μ","ν","ο","π","ρ","σ","τ","υ","ω","ξ","ψ","ζ","η","θ","χ","\＋","－","×","÷","・","／","\/","±","：","\＝","≒","≠","=","＞","＜","\>","<","≧","≦","（","）","｛","\{","｝","\}","［","］","｜","\\|","∽","⊥","∠","⊿","⌒","平行四辺形","∪","∩","→","←","√","！","\!","\\(","\\)","\\[","\\]"],["‡a","‡b","‡c","‡e","‡f","‡g","‡i","‡k","‡l","‡m","‡n","‡o","‡p","‡r","‡s","‡t","‡y","‡w","‡x","‡y","‡z","‡さ","‡す","‡へ","†a","†b","†c","†e","†f","†g","†i","†k","†l","†m","†n","†o","†p","†r","†s","†ｔ","†y","†w","†x","†y","†z","†さ","†す","†へ","？","を","＊","分","わ","｜分","｜分","？を","中促","ーー","中ー","‡ー","ーー","？？","をを","？？","をを","ヱヱ","語語","語","ん","半き","半き","よわ","よわ","半み","もわ","し","し","半わ","んわ","す","ゆ","こ","｜分分","ゆ","く","ーた","こー","根","外！","外！","語","ん","半み","もわ"]];
